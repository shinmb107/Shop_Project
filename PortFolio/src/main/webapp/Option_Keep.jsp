...
<body>
	...
	try {
		...
		switch (keep) {
		case "1":
			sql += "AND p_keep LIKE '%냉장보관%' ORDER BY p_keep ASC";
			break;
		case "2":
			sql += "AND p_keep LIKE '%냉동보관%' ORDER BY p_keep ASC";
			break;
		case "3":
			sql += "AND p_keep LIKE '%실온보관%' ORDER BY p_keep ASC";
			break;
		default:
			out.println("잘못된 요청입니다.");
			return;
