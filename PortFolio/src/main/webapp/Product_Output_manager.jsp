...
<script>
	function del(){
		if(!confirm("삭제하시겠습니까?")){
     		...
     		location.href="Product_Delete.jsp?p_num=<%=p_num%>";
     	}
	}
	function buy(){
...
<body>
	...
	<div class="center">
		...
		<table class="tablepo1">
			<tr height="40">
				<td rowspan="7" width="300" style="text-align: center;">
			...
			<tr height="30">
				<td colspan="2" style="text-align: center;">
					<input type="button" onclick="history.back()" value="다른상품">
					&emsp;
					<input type="button" onclick="location.href='Product_Update.jsp?p_num=<%=p_num%>'" value="수정하기">
					&emsp;
					<input type="button" onclick="del()" value="삭제하기">
					&emsp;
					<input type="button" onclick="location.href='Product_Form.jsp'" value="새로작성">
					&emsp;
					<input type="button" onclick="buy()" value="구매하기">
				</td>
			</tr>
		</table>
	</div>
