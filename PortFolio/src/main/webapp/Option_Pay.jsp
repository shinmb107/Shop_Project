...
<body>
	...
	try {
		...
		switch (pay) {
		case "1":
			sql += "AND p_pay < 10000 ORDER BY p_pay ASC";
			break;
		case "2":
			sql += "AND p_pay >= 10000 AND p_pay < 30000 ORDER BY p_pay ASC";
			break;
		case "3":
			sql += "AND p_pay >= 30000 AND p_pay < 50000 ORDER BY p_pay ASC";
			break;
		case "4":
			sql += "AND p_pay >= 50000 ORDER BY p_pay ASC";
			break;
		default:
			out.println("잘못된 요청입니다.");
			return;
